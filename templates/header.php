...
<header>
    <a href="./index.php" class="logo" style="margin-top: 0;"><svg fill="white" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="30px" viewBox="0 0 45.973 45.972">
            <g>
                <g>
    ...
    <div class="flex">
        ...
        <form name="<?php echo $logout_form_name ?>" method="post" action="">
            <input type="hidden" name="form-name" value="logout-form">
            <button type="submit" class="link-button" style="margin-top: 0"><svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
